...
namespace UFF.Infra.Migrations
{
    ...
    [Migration("20250624222849_adiciona_tabela_de_notificacao_e_controller")]
    partial class adiciona_tabela_de_notificacao_e_controller
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UFF.Domain.Entity.FavoriteProfessional", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("integer")
                        .HasColumnName("user_id");
                    ...
                    b.ToTable("favorite_professional", (string)null);
                });

            modelBuilder.Entity("UFF.Domain.Entity.FavoriteStore", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("integer")
                        .HasColumnName("user_id");
                    ...
                    b.ToTable("favorite_store", (string)null);
                });
            ...
            modelBuilder.Entity("UFF.Domain.Entity.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("UFF.Domain.Entity.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("UFF.Domain.Entity.Store", b =>
                {
                    ...
                    b.Property<bool>("EndServiceWithQRCode")
                        .HasColumnType("boolean")
                        .HasColumnName("end_service_with_q_r_code");

                    b.Property<string>("Facebook")
                        .HasColumnType("text")
                        .HasColumnName("facebook");

                    b.Property<bool>("InCaseFailureAcceptFinishWithoutQRCode")
                        .HasColumnType("boolean")
                        .HasColumnName("in_case_failure_accept_finish_without_q_r_code");
                    ...
                    b.Property<bool>("ReleaseOrderBeforeGetsQueued")
                        .HasColumnType("boolean")
                        .HasColumnName("release_order_before_gets_queued");

                    b.Property<bool>("ShareQueue")
                        .HasColumnType("boolean")
                        .HasColumnName("share_queue");

                    b.Property<string>("Site")
                        .HasColumnType("text")
                        .HasColumnName("site");

                    b.Property<bool>("StartServiceWithQRCode")
                        .HasColumnType("boolean")
                        .HasColumnName("start_service_with_q_r_code");
            ...
            modelBuilder.Entity("UFF.Domain.Entity.User", b =>
                {
                    ...
                    b.Property<bool>("LooseCustomer")
                        .HasColumnType("boolean")
                        .HasColumnName("loose_customer");
            ...
            modelBuilder.Entity("UFF.Domain.Entity.Notification", b =>
                {
                    b.HasOne("UFF.Domain.Entity.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("f_k_notification__user_user_id");
